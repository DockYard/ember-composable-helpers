...
export function cycle(currentValue, array, useDeepEqual = false) {
  ...
  return currentIndex === lastIndex ? array[0] : array[currentIndex + 1];
}

export default createNeedleHaystackHelper(cycle);
